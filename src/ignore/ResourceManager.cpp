...
ResourceManager::ResourceManager() {
    ...
    create_directory(DIR_GRAPHICS);
    create_directory(DIR_SHADERS);
    create_directory(DIR_MESHES);
    create_directory(DIR_MATERIALS);
    create_directory(DIR_PHYSICS);
    create_directory(DIR_SOUNDS);
    create_directory(DIR_WORLD);
    create_directory(DIR_INPUT);
    create_directory(DIR_SETTINGS);
    create_directory(DIR_SAVES);
}
...
void ResourceManager::loadPrograms(Graphics *const &graphics) {
    ...
    while (file) {
        if (*--item.end() == ':') {
            ...
            programs.insert(ShaderProgramPair(programName, program));
        }
    }

    graphics->setShaderPrograms(programs);
    graphics->setActiveShaderProgram(activeProgram);
}
*/
/*
...
/*
InputManager *ResourceManager::loadInputManager() {
